...
# java -jar ${PWD}/dist/challenge-1.0.0.war --com.mesosphere.challenge.service.storage.path=${INIT_STORAGE_PATH}
java -jar ${PWD}/dist/challenge-1.0.0.war --com.mesosphere.challenge.service.storage.path=${INIT_STORAGE_PATH} --com.mesosphere.challenge.service.storage.file=challengedb
